...
const io = socketIo(server, {
  cors: {
    origin:"http://localhost:5174",//originList.length > 0 ? originList : ["https://real-time-trackingofbuses.netlify.app","http://localhost:5174"],//"https://real-time-trackingofbuses.netlify.app",
    methods: ["GET", "POST"]
  }
});
connectDb().then(() => {
